...
def _setup_calculation(
    ...
    prefix: str | None,
    **kwargs,
) -> tuple[Path, Path, Path, QEConfig, dict]:
    """Common setup for calculations. Returns smart defaults applied."""
    ...
    return calc_dir, input_file, output_file, config, defaults
...
def run_scf(
    ...
    """
    calc_dir, input_file, output_file, config, defaults = _setup_calculation(
        structure=structure,
        calculation="scf",
        ecutwfc=ecutwfc,
        ecutrho=ecutrho,
